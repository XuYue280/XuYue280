...
double TestHugeInteger::HugeIntTiming(){
	system_clock::time_point startTime, endTime;
	double runTime=0.0;
	double durationMs=0.0;

	int n = 10000;
	int MAXNUMINTS=10;//how many int are doing +-*/
	int MAXRUN=100;//+-*/ how many time
	...
	for(int numRun=0; numRun < MAXRUN; numRun++){
		...
		cpp_int huge3 =huge1.multiply_boost(huge2);
		cout<<"running  "<<numInts<<" "<<numRun<<endl;
