...
void testCopy_add_1() {
        ...
        string expectedCopied = "1, 2, 3, 7, 8";
        int expectedObj2Size = 5;
        int expectedCopiedSize = 5;
...
void testRemove_add_6() {

    //int arr[] = {0, 1, 2, 3, 4}; // this list
    SLLSet listObj2 =  SLLSet();

        int removefirst = 15;  // test remove
...
void testUnion_add_3() {
        // test union
    //int arr[] = {15,20,100,3000}; // this list
...
void testIntersection_add_2() {

    int arr[] = {1, 2, 3, 7, 8}; // this list
    SLLSet listObj2 =  SLLSet(arr,5);


    int inter1000[] = {1, 2, 3, 7, 8}; //test intersection 'S'

    SLLSet listObj1000 = SLLSet(inter1000,5);
    SLLSet listObj1001 = listObj2.intersection(listObj1000);

        string expected = "1, 2, 3, 7, 8";
        int expectedSize = 5;

        ASSERT_EQUAL(expectedSize,listObj1001.getSize());
        ASSERT_EQUAL(expected,listObj1001.toString());
...
void testDifference_add_7() {

	      // parameters inpt here

    	int arr[] = {1, 2, 3, 7, 8}; // this list
    	SLLSet listObj17 = SLLSet(arr,5);

    	SLLSet listObj2 =  SLLSet();
        SLLSet listObj1000 = listObj2.difference(listObj17);
...
void testUnionSLLSetArray_add_8() {
...
bool runAllTests(int argc, char const *argv[]) {
	...
	s.push_back(CUTE(testCopy_add_1));
	s.push_back(CUTE(testIntersection_add_2));
	s.push_back(CUTE(testUnion_add_3));
	s.push_back(CUTE(testIsIn_add_4));
	s.push_back(CUTE(testAdd_add_5));
	s.push_back(CUTE(testRemove_add_6));
	s.push_back(CUTE(testDifference_add_7));
	s.push_back(CUTE(testUnionSLLSetArray_add_8));
